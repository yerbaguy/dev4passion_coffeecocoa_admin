    ...
    getData.forEach((element, index) => {
        let createElement = `<tr class="employeeDetails">
            ...
            <td>
                ...
                <button style="background-color: #855c37" class="btn btn-primary" onclick="editInfo(${index}, '${element.picture}', '${element.coffee_roasted_product_description}', '${element.coffee_roasted_farm}', '${element.coffee_roasted_farmer}', '${element.coffee_roasted_roaster}','${element.coffee_roasted_dealer}', '${element.coffee_roasted_brand}', '${element.coffee_roasted_origin}')" data-bs-toggle="modal" data-bs-target="#userForm">edit</button>

                <button style="background-color: #855c37" class="btn btn-danger" onclick="deleteInfo(${index})">delete</button>
